...
public class TestMathStory extends JUnitStories {
	
	
	private static List<String> storyPaths = Arrays.asList("org/jbehave/test/JbehaveTest/Math.story");
	
	private Configuration configuration;
	
	public TestMathStory() {
		super();
	...
	public InjectableStepsFactory stepsFactory() {
		return new InstanceStepsFactory(configuration(), new RunMathStory());
	}
