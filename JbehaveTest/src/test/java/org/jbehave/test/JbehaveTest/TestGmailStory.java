...
public class TestGmailStory extends JUnitStories {
	
	
	private static List<String> storyPaths = Arrays.asList("org/jbehave/test/JbehaveTest/Gmail.story");
	
	private Configuration configuration;
	
	public TestGmailStory() {
		super();
	...
	public InjectableStepsFactory stepsFactory() {
		return new InstanceStepsFactory(configuration(), new RunGmailStory());
	}
